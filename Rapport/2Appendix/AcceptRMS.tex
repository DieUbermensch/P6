...
\section{Setup}
The setup of this test are depicted in \autoref{fig:AcceptFreqResponse2}, where the equipment is catalogued in \autoref{tab:UsedEquipmentFreqResponse}, and described as follows:
