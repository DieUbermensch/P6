...
\begin{itemize}
\item There shall be a reason for implementing an Equalizer.
\end{itemize}
...
\end{itemize}
These are classified by looking at the fundamental frequency and is then categorized by how far away, indexed by whole integers, they are from the fundamental frequency. 

Generally speaking it is desirable to have even harmonics since they are perceived as "warm and full" sound. Odd harmonics are perceived as "cold and metallic". 
