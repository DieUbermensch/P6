...
This section will describe the internal amplifier in a active loudspeaker and analyze how distortion is created in the amplifier.

The amplifier is the module which amplifies the input signal. There are several diffenrent classes of amplifiers for example class A, AB and D, these classes have different characteristics which gives them different advantages and disadvantages. The two main parameters for the performance of a amplifier is distortion and efficiency. There are several kinds of distortion in a amplifier, such as unlinearity in the components, cross over distortion and audio clipning.
