...
\end{align}
\begin{where}
\va{$\omega_0$}{is square-wave frequency}{rad/s}\\
\end{where}


The spectrum of the 1 kHz unclipped and clipped sinusoid from \autoref{fig:audioclipping} is shown in \autoref{fig:audioclippingFFT}.
