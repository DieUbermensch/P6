...
The main topic of this chapter is to analyse an active loudspeaker and examine any issues concerning distortion in an active loudspeaker, since it is commonly known that distortion adds undesirable artefacts to the sound. %The purpose of this chapter is therefore to examine if it is possible to increase the maximum performance of an active loudspeaker without creating more distortion. 
