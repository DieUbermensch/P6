...
\aautitlepage{%
 ...
 This project concerns the development of a active loudspeaker protective system which prevents the loudspeaker coil from hitting the backplate. The implemented system is a feedforward system with five RMS limiters are implemented in a multi-rate system to distribute the limitation over multiple bands. The system were implemented into a TMS320C5515 EZDSP and most requirements were fulfilled. 
}